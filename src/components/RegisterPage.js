                        ...
                        <div className="col-sm-10 col-md-8 col-lg-7 col-xl-6 col-xxl-5">
                            <div className="card card-body rounded-3 p-4 p-sm-5 mb-5" >
                                <div className="text-center">
                                    ...
                                    <span className="d-block">Already have an account? <Link to="/">Login here</Link>
                                    </span>
                                </div>
                                <form className="mt-4" onSubmit={submitForm}>
                                    ...
                                    <div className="d-grid">
                                        <button type="submit" onClick={submitForm} className="btn btn-lg btn-primary">Fill up and register</button>
                                    </div>
                                </form>
                            </div>
                        </div>
